...
- [x] Add tests to verify tools. 1. schema generation. 2. sandbox enforcement. 3. tool execution returns ToolResult with correct call_id. 4 Errors are correctly formatted. Definitions should work across providers.
